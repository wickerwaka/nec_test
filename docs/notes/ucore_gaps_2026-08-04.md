...
| **F3** | functional | **INM/OUTM (6C-6F) block I/O was rendered but ungated.** Measured this session: **229,999 / 229,999 cycles AND arch** over all 23 `v0.3` block-I/O forms | **CLOSED** | — | — (registered; add to the standing set) |
...
| **R7** | doc | **`ROADMAP.md` carries stale U4 pass-3 figures** (26 % ALMs / 45.56 MHz, "two flashes") where the campaign closed on the U5 build (27 % / 48.03 MHz, three flashes) | 2 statements | doc | corrected in §Z.4 |
